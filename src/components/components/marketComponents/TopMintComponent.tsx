...
const baseURL = "https://api.nftgo.io/api/v1/ranking/top-mint?timeRank=5m&by=MintNum&asc=-1&isListed=-1";

const TopMint = () => {
  const [topMintData, setData] = useState([]);
  const mintFomo = [
    "Low",
    "Medium",
    "High"
              ...
              <tr>
                <td className="bg-3b3363">
                  ...
                  <img
                    ...
                    className="img-fluid"
                  />
                  <p className="d-inline-block mb-0">{mintData["contractName"]}</p>
                </td>
                <td className="bg-3b3363">
                  <p className="text-right">{mintData["mintNum"]}</p>
                ...
                <td className="bg-3b3363">
                  ...
                  <p className="d-inline-block">{mintData["mintVolume"]}</p>
                  <div className="bg-5b5288 table-progress-bar">
                    {/*<Progress*/}
                    {/*    className="bg-5b5288"*/}
                    {/*    value={m.mint_volume}*/}
                ...
                <td className="bg-3b3363">
                  <p className="text-right">{mintData["minterNum"]}</p>
                  <div className="bg-5b5288 table-progress-bar">
                    {/*<Progress*/}
                    {/*    className="bg-5b5288"*/}
                    {/*    value={m.minters}*/}
                ...
                <td className="bg-3b3363">
                  <p className="text-right">{mintData["whaleNum"]}</p>
                  <div className="bg-5b5288 table-progress-bar">
                    {/*<Progress*/}
                    {/*    className="bg-5b5288"*/}
                    {/*    value={m.whales}*/}
                ...
                <td className="bg-3b3363">
                  <p className="text-right">{mintData["totalGasFee"]}</p>
                  <div className="bg-5b5288 table-progress-bar">
                    {/*<Progress*/}
                    {/*    className="bg-5b5288"*/}
                    {/*    value={m.total_gas}*/}
                ...
                <td className="bg-3b3363">
                  <span>{mintData["firstMintTime"]}</span>
                </td>
                <td className="bg-3b3363">
                  <span>{mintFomo[mintData["fomo"] - 1]}</span>
                </td>
              </tr>
            )
